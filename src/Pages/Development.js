...
import razbacksh from '../assets/razbacksh.jpg'
            ...
            <>
                ...
                <div className='text-razrab'>
                    ...
                    <Col sm={6}>
                        ...
                        <p/>Диаметр основного зеркала, м 5
                        <br/>Тип ОПУ  2-х угломестный
                        <br/>Диапазон наведения по осям, ° ±180
                        <br/>Максимальная скорость наведения, °  9
                        <br/>Температурный диапазон работы, °C -40…+50
                        <br/>Максимальная скорость ветра при работе, м/с 25
                        <br/>Суммарная ошибка наведения, угл. сек не более 30*
